(function () {
  ...
  function populateFilters() {
    ...
    heroStateSelect.innerHTML = states
  ...
  function renderStateDetail() {
    ...
    stateBadge.textContent = `${scoreLabels[Object.entries(state.scores).sort((a, b) => b[1] - a[1])[0][0]]} lead`;
    ...
    stateHealth.innerHTML = `
      <article class="health-card">
        ...
        <div class="mini-label">${filteredDocuments.length} visible records</div>
      </article>
      <article class="health-card">
      ...
      <article class="health-card">
        ...
        <div class="mini-label">${state.geography.hotspotDistrict}</div>
      </article>
    `;
  ...
  heroGo.addEventListener("click", () => {
    ...
    filters.state = selectedStateId;
    filterState.value = selectedStateId;
    renderAll();
  });
