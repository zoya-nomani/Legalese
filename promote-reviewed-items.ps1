...
function Find-DecisionForItem {
  ...
  foreach ($decision in $Decisions) {
    ...
    if ($decision.title -and $decision.jurisdictionId -and $decision.clauseId) {
      if ($decision.title -eq $Item.title -and $decision.jurisdictionId -eq $Item.jurisdictionId -and $decision.clauseId -eq $Item.clauseId) {
        return $decision
      }
    }
  }
